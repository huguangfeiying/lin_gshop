      ...
      <div class="rating-wrapper">
        <ul>
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            <div class="avatar">
              <img width="28" height="28" :src="rating.avatar" alt="商家评价">
            </div>
            <div class="content">
...
export default {
  data () {
    return {
      onlyShowText: true, // 是否显示文本
      selectType: 2 // 选择评价的类型：0-满意 1-不满意 2-全部
    }
  },
  mounted () {
  ...
  computed: {
    ...
    filterRatings () {
      ...
      return Array.prototype.slice.call(shopRatings).filter((rating) => {
